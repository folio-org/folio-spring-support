...
public class SystemUserService {
   ...
   * @return {@link org.folio.spring.model.SystemUser} with token value
   */
  public SystemUser getAuthedSystemUser(String tenantId) {
    ...
    if (userToken.accessTokenExpiration().isAfter(now)) {
      var newToken = login(user.username());
   ...
   *
   * @param user {@link org.folio.spring.model.SystemUser} to log with
   * @return token value
   */
