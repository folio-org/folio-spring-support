...
public class EntitlementReconciliationTask {
   ...
   */
  @Scheduled(
    fixedDelayString = "${" + KafkaTenantFilterProperties.CONFIG_PREFIX + ".entitlement-refresh-interval-seconds:900}",
    initialDelayString =
      "${" + KafkaTenantFilterProperties.CONFIG_PREFIX + ".entitlement-refresh-interval-seconds:900}",
