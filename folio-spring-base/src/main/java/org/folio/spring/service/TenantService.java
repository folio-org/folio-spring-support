...
public class TenantService {
  ...
  /**
   * Custom logic to be run before a tenant is created or updated.
   */
  ...
  /**
   * Custom logic to be run before a tenant's database is created with liquibase.
   */
  ...
  /**
   * Custom logic to be run after a tenant's database is created with liquibase.
   */
  ...
  /**
   * Custom logic to be run after a tenant is created or updated.
   */
  ...
  /**
   * Custom logic to be run before a tenant is deleted.
   */
  ...
  /**
   * Custom logic to be run after a tenant is deleted.
   */
