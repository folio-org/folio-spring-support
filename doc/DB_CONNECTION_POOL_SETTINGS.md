...
1. Environment variables (recommended for deployments; for example, `export DB_MAXPOOLSIZE=10`)
2. JVM system properties (for local or process-specific overrides; for example, `-DDB_MAXPOOLSIZE=10`)
